...
function LoginForm({submitHandler}) {
    ...
    return (
        ...
        <form className="flex flex-col w-1/2 gap-4 p-8 mx-auto my-4 text-center bg-green-200 border-2 border-green-400 rounded-lg text-md " onSubmit={e=>submitHandler(e,credintials)} method='post'>
            ...
            <button className="px-3 py-4 mt-8 uppercase bg-green-500 rounded text-green hover:bg-green-600 text-green-50" type="submit">Sign In</button>
